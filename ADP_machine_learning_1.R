...
#' survived and dead ratio comparing between train dataset and test dataset
...
#' 머신러닝 알고리즘별 최적 모수를 찾기 위한 학습방법 사전 설정해야 한다.
...
#' training data as data.table() 
training <- as.data.table(traing)
